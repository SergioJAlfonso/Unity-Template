...
public class FMODStudioFirstPersonFootsteps : MonoBehaviour
{
    ...
    [SerializeField] private EventReference FootstepsEventPath;    // Use this in the Editor to select our Footsteps Event.
    [SerializeField] private EventReference JumpingEventPath;      // Use this in the Editor to select our Jumping Event.
